...
// if there is nothing in the customers cart, redirect them to the shopping cart page
  ...
  require(DIR_WS_LANGUAGES . $language . '/' . str_replace("mobile_", "", FILENAME_CHECKOUT_SHIPPING_ADDRESS));
...
<hr />
  ...
  $ShipAddress=tep_draw_form('shipaddress', tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'NONSSL'), 'post');
  ...
  // only display addresses if more than 1
  	  ...
  	  $ShipAddress.= '<div id="ship_add">' . tep_draw_hidden_field('action', 'submit') . tep_draw_pull_down_menu('address', $addresses_array, $selected_address, 'onchange="return shippingaddress_submit(\'\');" style="width: auto"') . '</div>';
  ?>
  <div>
  <?php
	$ShipAddress .= '</form>';
