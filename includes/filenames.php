...
//BOF Gallery Photos
define('FILENAME_PHOTO_GALLERY', 'photo_gallery.php');
//EOF Gallery Photos
...
// ################# Contribution Newsletter by brouillard s'embrouille ##############
  ...
  define('FILENAME_NEWSLETTER_ABONNEMENT_SUCCESS', 'newsletter_abonnement_success.php');
  define('FILENAME_NEWSLETTER_DESABONNEMENT', 'newsletter_desabonnement.php');
  define('FILENAME_NEWSLETTER_DESABONNEMENT_SUCCESS', 'newsletter_desabonnement_success.php');
