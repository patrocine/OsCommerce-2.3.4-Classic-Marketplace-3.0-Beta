...
// Outputs a button in the selected language
  function tep_image_submit($image, $alt = '', $parameters = '', $button_number = '',  $override = false) {
    global $language;

     if (function_exists('az_draw_image_submit_button') && $override == false)
     {
        $image_submit = az_draw_image_submit_button($alt, $button_number, $parameters);
     }
     else
     {
...
// Output a function button in the selected language
  function tep_image_button($image, $alt = '', $parameters = '', $button_number = '', $override = false) {
    global $language;

     if (function_exists('az_draw_image_button') && $override == false)
     {
     	return az_draw_image_button($alt, $button_number, $parameters);
     }
     else
     {
...
// Output a jQuery UI Button
  function tep_draw_button($title = null, $icon = null, $link = null, $priority = null, $params = null, $button_number = '', $override = false) {
    ...
    #AZ BOF
    if ( ($params['type'] == 'submit') && function_exists('az_draw_image_submit_button') && $override == false )  {
        $button = az_draw_image_submit_button($title, $button_number, (isset($params['params']) ? $params['params'] : null ));
    }
    if ( ($params['type'] == 'button') && function_exists('az_draw_image_button') && $override == false )  {
        $button = '<a href="'.$link.'">'.az_draw_image_button($title, $button_number, (isset($params['params']) ? $params['params'] : null )).'</a>';
    }
    #AZ EOF
