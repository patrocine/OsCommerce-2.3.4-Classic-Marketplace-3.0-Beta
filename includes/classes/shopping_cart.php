      ...
      if ($products_porcentage = tep_db_fetch_array($products_porcentage_values)){
              ...
              $descuento_insert = $products_porcentage['products_descuento'];
                $product['products_price'] = $product['products_price'] *$descuento_insert/100+$product['products_price'];
                 ...
                 // calula el //descuento de del cliente  total
...
if (($orders_customers = tep_db_fetch_array($orders_customers_price)) && ($customer_group_id['customers_group_id'] != 0)) {
       ...
       $customers_porcentage = tep_db_fetch_array($customers_porcentage_values);
              ...
              if ($customers_porcentage['customers_porcentage'] <> 0){
              $descuento_insert = $customers_porcentage['customers_porcentage'];
                $orders_customers['customers_group_price'] = $orders_customers['customers_group_price'] *$descuento_insert/100+$orders_customers['customers_group_price'];
         }
