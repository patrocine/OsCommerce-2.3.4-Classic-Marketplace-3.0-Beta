...
// class constructor
    function moneyorder() {
      ...
      $this->email_footer = 'Datos Bancarios para el pago</p> ' . STORE_BANK_ADDRESS_MODULES .'</p> '. STORE_BANK_NAME_MODULES . '</p>En observaciones del pago poner el número de pedido o su correo electronico';
    }
...
// class methods
    ...
    function confirmation() {
      return array('title' => 'Datos Bancarios para el pago</p> ' . STORE_BANK_ADDRESS_MODULES .'</p> '. STORE_BANK_NAME_MODULES . '</p>En observaciones del pago poner el número de pedido o su correo electronico');
    }
