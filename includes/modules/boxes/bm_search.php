...
*/
  ...
  /************** BEGIN SITESEARCH CHANGE ****************/        
      ...
      $catBox = ($showCatBox ? '<div style-"padding-top:5px;">' . BOX_ADVSEARCH_CAT . '</div><div>' . tep_draw_pull_down_menu('categories_id', tep_get_categories(array(array('id' => '', 'text' => BOX_ADVSEARCH_ALLCAT))), '', 'style="width:' . $catBoxWidth . ';"') . '</div>' : '');
      $priceBoxes = ($showPrice ? '<div style="margin-top:10px;">' . BOX_ADVSEARCH_PRICERANGE . '</div><div>' . tep_draw_input_field('pfrom','','size="4" maxlength="8"') . BOX_ADVSEARCH_PRICESEP . tep_draw_input_field('pto','','size="4" maxlength="8"') . '</div>' : '');
  ...
  /************** END SITESEARCH CHANGE ****************/  
      ...
      $infobox->azSetBoxHeading(MODULE_BOXES_SEARCH_BOX_TITLE);
