...
*/
  ...
  class bm_information {
    ...
    function execute() {
      ...
      $content = '    <a href="' . tep_href_link(FILENAME_SHIPPING) . '">' . MODULE_BOXES_INFORMATION_BOX_SHIPPING . '</a><br />' .
              ...
              '    <a href="' . tep_href_link(FILENAME_MY_POINTS_HELP) . '">' . BOX_INFORMATION_MY_POINTS_HELP . '</a>';

      $infobox = new azInfoBox();
      $infobox->azSetBoxHeading(MODULE_BOXES_INFORMATION_BOX_TITLE);
