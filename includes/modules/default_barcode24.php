...
<?php
 ...
 // tep_db_query("delete from " . TABLE_SPECIALS . " where specials_new_products_price = '" . 0 . "'");
   ...
   $simulacro =  '<img src="barcodegen.php?barcode=' . $default_specials['products_id'] . ' ">
                  <p style="margin-top: 0; margin-bottom: 0"><font face="Verdana" style="font-size: 3pt">'. $default_specials['products_model'] . ' - ' . $default_specials['products_name'].'</font><font size="1" face="Verdana"></font></p>
                  <p style="margin-top: 0; margin-bottom: 0"><font face="Verdana" style="font-size: 10pt"> ('.$currencies->format($default_specials['final_price']).')</font></p><p style="margin-top: 4; margin-bottom: 4">&nbsp;</p><p style="margin-top: 6; margin-bottom: 6">&nbsp;</p>';
