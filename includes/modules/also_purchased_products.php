...
<?php
      ...
      $info_box_contents[] = array('text' => '<div class="title">'.TEXT_ALSO_PURCHASED_PRODUCTS.'</div>');
      ...
      while ($orders = tep_db_fetch_array($orders_query)) {
        ...
        $info_box_contents[$row][$col] = array('align' => 'center',
											   ...
											   <a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $orders['products_id']) . '">' . $orders['products_name'] . '</a>
											   </div>
											   ...
											   <a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $orders['products_id']) . '">' . tep_image(DIR_WS_IMAGES . $orders['products_image'], $orders['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a>
											   </td></tr></table>
