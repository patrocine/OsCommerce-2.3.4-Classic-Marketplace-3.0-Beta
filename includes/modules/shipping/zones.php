...
// class constructor
    function zones() {
      $this->code = 'zones';
      $this->title = MODULE_ENVIO_CONTRAREEMBOLSO;
...
// class methods
    function quote($method = '') {
      ...
      $this->quotes = array('id' => $this->code,
                            'module' => MODULE_ENVIO_CONTRAREEMBOLSO,
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Titulo del modo de envio.', 'MODULE_ENVIO_CONTRAREEMBOLSO', 'Contrareembolso', 'Titulo del modo de envío..', '6', '0', now())");
       ...
       for ($i = 1; $i <= $this->num_zones; $i++) {
        ...
        tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Zone " . $i ." Shipping Table', 'MODULE_SHIPPING_ZONES_COST_" . $i ."', '0.01:0.00,0.10:5.00,0.20:05.00,0.35:5.50,1.00:7.20,2.00:7.50,5.00:9.60,10.00:9.00,15.00:11.00,20.00:14.00,25.00:15.50,30.00:21.00,35.00:25.00,40.00:30.00,50.00:40.00,60.00:50.00,70.00:60.00,80.00:70.00,90.00:80.00,100.00:90.00,200.00:150.00', 'Shipping rates to Zone " . $i . " destinations based on a group of maximum order weights. Example: 3:8.50,7:10.50,... Weights less than or equal to 3 would cost 8.50 for Zone " . $i . " destinations.', '6', '0', now())");
    ...
    function keys() {
      $keys = array('MODULE_SHIPPING_ZONES_STATUS', 'MODULE_ENVIO_CONTRAREEMBOLSO', 'MODULE_SHIPPING_ZONES_TAX_CLASS', 'MODULE_SHIPPING_ZONES_SORT_ORDER');
