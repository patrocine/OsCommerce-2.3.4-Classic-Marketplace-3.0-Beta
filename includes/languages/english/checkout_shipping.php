...
define('TEXT_ENTER_SHIPPING_INFORMATION', 'Esta es la &uacute;nica forma de env&iacute;o disponible para su pedido.');

define('TABLE_HEADING_COMMENTS', '¿Tiene comentarios sobre su pedido?');
