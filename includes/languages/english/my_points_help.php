...
define('POINTS_FAQ_1', '¿Qué es el Programa de Puntos?');
define('POINTS_FAQ_2', '¿Cómo funciona el programa?');
define('POINTS_FAQ_3', 'Puntos y Valores');
define('POINTS_FAQ_4', 'Puntos de Compra Canjeados');
define('POINTS_FAQ_5', 'Puntos mínimos requeridos');
define('POINTS_FAQ_6', 'Cantidad Compra mínima requerida');
define('POINTS_FAQ_7', 'El máximo de puntos Reembolsos permitidos por pedido es de');
define('POINTS_FAQ_8', '¿Se consiguen puntos por los gastos de envío?');
...
define ('POINTS_FAQ_13', 'Cómo ganar puntos Al escribir su opinion');
...
<br /><br />Nuestro Programa de Puntos es tan simple como suena. Mientras que las compras en ' . STORE_NAME . ' usted ganará Puntos de Compra por el dinero que gaste.
<br />Una vez confirmado, usted podrá usar esos puntos para pagar futuras compras en ' . STORE_NAME . '.
<br /><br />El Programa de Puntos entro en vigor el&nbsp; ' . tep_get_last_date('USE_POINTS_SYSTEM') . ' . Todas las compras realizadas después de esta
fecha ganan puntos.');

// FAQ2
define('TEXT_FAQ_2', 'Cuando se hace un pedido, la cantidad total<small><font color="FF6633">*</font></small> de la orden se utilizará para calcular la cantidad de puntos ganados.
