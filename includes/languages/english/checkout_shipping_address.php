...
define('TEXT_CREATE_NEW_SHIPPING_ADDRESS', 'Use el siguiente formulario para crear una direcci&oacute;n nueva en su libreta y usarla como direcci&oacute;n de entrega para su pedido.');

define('TITLE_CONTINUE_CHECKOUT_PROCEDURE', 'Continuar con el proceso de compra');
define('TEXT_CONTINUE_CHECKOUT_PROCEDURE', 'para seleccionar la forma de env&iacute;o.');
?>
