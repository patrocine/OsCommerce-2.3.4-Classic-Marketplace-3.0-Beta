...
define('TEXT_DISPLAY_NUMBER_OF_CLICKS', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> clickthroughs)');
define('TEXT_CLICKTHROUGH_HELP', ' <font color="#FFFFFF">[?]</font>');
define('TEXT_CLICKS', 'Hover over [-?-] to see a description of each category.');
