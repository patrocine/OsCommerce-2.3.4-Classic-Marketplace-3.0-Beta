...
// reset the session variables
  ...
  $account_query = tep_db_query("select customers_gender, customers_firstname, customers_lastname, customers_billetera, customers_dob, customers_email_address, customers_telephone, customers_fax from " . TABLE_CUSTOMERS . " where customers_id = '" . (int)$customer_id . "'");
...
?>
      ...
      <tr>
        <td class="fieldKey"><?php echo 'Billetera' ?></td>
        <td class="fieldValue"><?php echo tep_draw_input_field('customers_billetera', $account['customers_billetera']) . '&nbsp;' . (tep_not_null(ENTRY_LAST_NAME_TEXT) ? '<span class="inputRequirement">' . ENTRY_LAST_NAME_TEXT . '</span>': ''); ?></td>
      </tr>
