...
<?php
    ...
    $product_info_query = tep_db_query("select p.products_id, pd.products_viewed, p.products_last_modified, p.products_date_added, pd.products_viewed, p.stock_disponible_proveedor, p.codigo_proveedor, p.stock_nivel, p.manufacturers_name, p.referencia_fabricante, p.products_status, p.time_entradasysalidas, p.time_mercancia_entregado_procesando, pd.products_name, pd.products_description, p.products_model, p.products_quantity, p.products_image, pd.products_url, p.products_price, p.products_tax_class_id, p.products_date_added, p.products_date_available, p.manufacturers_id from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_DESCRIPTION . " pd where p.products_status = '1' and p.products_id = '" . (int)$HTTP_GET_VARS['products_id'] . "' and pd.products_id = p.products_id and pd.language_id = '" . (int)$languages_id . "'");
...
<div class="prodPrice"><?php echo $products_price; ?></div>
    ...
    data-text="<?php echo $products_price . ' ' . $product_info['products_name'] . ' #iOSC ' . $icecat . ' ' . $product_descripcion ; ?>"
...
// Points/Rewards system V2.1beta EOF
       ...
       if  ($product_info['manufacturers_name'] <> '' and $product_info['referencia_fabricante'] <> ''){
      ?>
      <IFRAME WIDTH="600" HEIGHT="500" FRAMEBORDER="0" style="overflow-X: none;overflow-Y:auto;" src="http://prf.icecat.biz/?shopname=openIcecat-url;smi=product;vendor=<?php echo $product_info['manufacturers_name']; ?>;prod_id=
...
$fecha = date("Y-m-d", $time1);
      ...
      echo '<p><b><font color="#008000">Alerta activada</font></b></p>';
          ...
          <p style="margin-top: 0; margin-bottom: 0"><b>Deja tu mail y te avisamos cuando este producto cambie de precio o de stock</b></p>
