...
<div class="pageHeading" style="padding:0 0 5px 4px;"><?php echo AZ_PAGE_HEADING_HOMEPAGE;?></div>
<div id="az_banner">
  <a href="<?php echo $tmpl['url']['index'];?>"><?php echo az_image(TMPL_IMAGES.'az_banner.jpg');?></a><a href="<?php echo $tmpl['url']['specials'];?>"><?php echo az_image(TMPL_IMAGES.'az_banner2.jpg');?></a><a href="<?php echo $tmpl['url']['products_new'];?>"><?php echo az_image(TMPL_IMAGES.'az_banner3.jpg');?></a>
</div>
