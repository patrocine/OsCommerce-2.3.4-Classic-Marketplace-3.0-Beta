...
<tr>
  <td>
    <table border="0" align="center">
      <tr>
        <td align="left" class="main"><a href="<? echo tep_href_link(FILENAME_PRODUCT_INFO, "products_id=$previous&cPath=$cPath"); ?>"><?php echo TEXT_ANTERIOR_INFO; ?></a></td>
<!--        <td align="center" class="main"><?php echo (PREV_NEXT_PRODUCT); ?><?php echo ($position+1 . "/" . $counter); ?><br><?php echo (PREV_NEXT_FROM) ?><?php echo ($category_name_row['categories_name']); ?></td> -->
        ...
        <td align="right" class="main"><a href="<? echo tep_href_link(FILENAME_PRODUCT_INFO, "products_id=$next_item&cPath=$cPath"); ?>"><?php echo TEXT_SIGUIENTE_INFO; ?></a></td>
      </tr>
    </table>
