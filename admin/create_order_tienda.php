...
*/
  ...
  require('includes/application_top.php');
    ...
    $Customer_nr = $_GET['Customer_nr'];
    $st_nombre = $_GET['st_nombre'];
   $st_traking = $_GET['st_traking'];
  $st_telefono = $_GET['st_telefono'];
...
<input type="checkbox" name="stock_disponible" value="ON" >
  <input name="palabraclave" type="text" value="" size="20" style="font-family: Verdana; font-size: 18pt; color: #000080; border-style: outset; border-width: 3; background-color: #FFFF00">
...
?>
      <?php echo tep_image_submit('tpv_crearpedido_1.jpg', IMAGE_BUTTON_CONFIRM); ?>
