...
*/
        // Batch Updte Status v0.1
        define('BUS_HEADING_TITLE','Batch Update Status');
        define('BUS_TEXT_NEW_STATUS', 'Select Nuevo Status');
        define('BUS_NOTIFY_CUSTOMERS', 'Notify Cliente(s)');
        define('BUS_SELECT_ALL', 'Todos');
        define('BUS_SELECT_NONE', 'Borrar Casillas');
        define('BUS_SUBMIT', 'Actualizar Status');
