...
*/
//BOF Gallery Photos
define('TEXT_DISPLAY_NUMBER_OF_GALLERY_PHOTOS', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> photos)');
...
define('IMAGE_BUTTON_CONFIRM', 'CREAR NUEVO PEDIDO');
//kgt - discount coupons
define('BOX_CATALOG_DISCOUNT_COUPONS', 'Cupones Descuentos');
//end kgt - discount coupons

//kgt - discount coupons report
define('BOX_REPORTS_DISCOUNT_COUPONS', 'Cupones Descuentos');
...
define (BOX_HEADING_COMPBUILD ,"Build Computer");
...
define('BOX_NEWSLETTER_MANAGER', 'Newsletter manager');
define('BOX_NEWSLETTER_INSCRITS_MANAGER', 'Subscriber manager');
...
// comment out or remove below lines to disable this contribution
...
define('BOX_ADMINISTRATOR_MEMBERS', 'Grupos');
define('BOX_ADMINISTRATOR_MEMBER', 'Miembros');
define('BOX_ADMINISTRATOR_BOXES', 'Acceso a ficheros');
define('TEXT_DISPLAY_NUMBER_OF_SALES', 'Numero de Paginas:');
...
define('HEADER_TITLE_SUPPORT_SITE', 'Soporte del Sitio');
...
define('BOX_TOOLS_DATABASE_ADMIN', 'Base de Datos');
