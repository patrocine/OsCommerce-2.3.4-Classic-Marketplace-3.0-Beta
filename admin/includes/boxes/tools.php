  ...
  $cl_box_groups[] = array(
    ...
    'apps' => array(
      ...
      array(
        ...
        array(
        'code' => FILENAME_DATABASE_ADMIN,
        'title' => BOX_TOOLS_DATABASE_ADMIN,
        'link' => tep_href_link(FILENAME_DATABASE_ADMIN)
      ),
      array(
      ...
      array(
        ...
        array(
        'code' => FILENAME_GALLERY_PHOTOS,
        'title' => BOX_TOOLS_GALARY_PHOTOS,
        'link' => tep_href_link(FILENAME_GALLERY_PHOTOS)
      )
    )
  );
?>
