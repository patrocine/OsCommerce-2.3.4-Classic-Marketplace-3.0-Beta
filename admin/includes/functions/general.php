...
function tep_admin_files_boxes($filename, $sub_box_name) {
  ...
  //$sub_boxes = '<a href="' . tep_href_link($filename) . '" class="menuBoxContentLink">' . $sub_box_name . '</a><br>';
      ...
      $sub_boxes = tep_href_link($filename);
...
// Text Mode
  ...
  function tep_get_category_name($category_id, $language_id) {
    ...
    return $category['categories_name'];
                      ...
                      //patrocine
  function tep_get_category_name_suple($category_id, $language_id) {
    $category_query = tep_db_query("select categories_name_suple from " . TABLE_CATEGORIES_DESCRIPTION . " where categories_id = '" . (int)$category_id . "' and language_id = '" . (int)$language_id . "'");
    $category = tep_db_fetch_array($category_query);

    return $category['categories_name_suple'];
  }
                 //patrocine
                 
                 
                      //patrocine
  function tep_get_category_name_status($category_id, $language_id) {
    $category_query = tep_db_query("select categories_status_visible from " . TABLE_CATEGORIES_DESCRIPTION . " where categories_id = '" . (int)$category_id . "' and language_id = '" . (int)$language_id . "'");
    $category = tep_db_fetch_array($category_query);

    return $category['categories_status_visible'];
  }
                 //patrocine
                 
                      //patrocine
  function tep_get_category_name_http($category_id, $language_id) {
    $category_query = tep_db_query("select categories_name_http from " . TABLE_CATEGORIES_DESCRIPTION . " where categories_id = '" . (int)$category_id . "' and language_id = '" . (int)$language_id . "'");
    $category = tep_db_fetch_array($category_query);

    return $category['categories_name_http'];
  }
                 //patrocine
                 
                      //patrocine
  function tep_get_category_name_http_mobil($category_id, $language_id) {
    $category_query = tep_db_query("select categories_name_http_mobil from " . TABLE_CATEGORIES_DESCRIPTION . " where categories_id = '" . (int)$category_id . "' and language_id = '" . (int)$language_id . "'");
    $category = tep_db_fetch_array($category_query);

    return $category['categories_name_http_mobil'];
  }
                 //patrocine
