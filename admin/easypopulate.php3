...
// si el precio es un numero ejecuto el siguiente codigo
 ...
 if ($v_products_price){
  ...
  // fin de alertas de mail.
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where products_extra_image = '" . $vv_products_image_extra_1 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){
          ...
          $sql_status_update_array = array('products_extra_image' => $vv_products_image_extra_1,);
            tep_db_perform('products_extra_images', $sql_status_update_array, 'update', " products_extra_image= '" . $vv_products_image_extra_1 . "'");


}else{

                     if ($vv_products_image_extra_1){
  ...
  // Actualiza o inserta las imagenes extras. del grupo 2
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where products_extra_image = '" . $vv_products_image_extra_2 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){


          $sql_status_update_array = array('products_extra_image' => $vv_products_image_extra_2,);
            tep_db_perform('products_extra_images', $sql_status_update_array, 'update', " products_extra_image= '" . $vv_products_image_extra_2 . "'");


}else{
                    if ($vv_products_image_extra_2){
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where products_extra_image = '" . $vv_products_image_extra_3 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){


          $sql_status_update_array = array('products_extra_image' => $vv_products_image_extra_3,);
            tep_db_perform('products_extra_images', $sql_status_update_array, 'update', " products_extra_image= '" . $vv_products_image_extra_3 . "'");


}else{
                            if ($vv_products_image_extra_3){
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where products_extra_image = '" . $vv_products_image_extra_4 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){


          $sql_status_update_array = array('products_extra_image' => $vv_products_image_extra_4,);
            tep_db_perform('products_extra_images', $sql_status_update_array, 'update', " products_extra_image= '" . $vv_products_image_extra_4 . "'");


}else{
                            if ($vv_products_image_extra_4){
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where products_extra_image = '" . $vv_products_image_extra_5 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){


          $sql_status_update_array = array('products_extra_image' => $vv_products_image_extra_5,);
            tep_db_perform('products_extra_images', $sql_status_update_array, 'update', " products_extra_image= '" . $vv_products_image_extra_5 . "'");


}else{
                            if ($vv_products_image_extra_5){
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where products_extra_image = '" . $vv_products_image_extra_6 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){


          $sql_status_update_array = array('products_extra_image' => $vv_products_image_extra_6,);
            tep_db_perform('products_extra_images', $sql_status_update_array, 'update', " products_extra_image= '" . $vv_products_image_extra_6 . "'");


}else{
                            if ($vv_products_image_extra_6){
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where products_extra_image = '" . $vv_products_image_extra_7 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){


          $sql_status_update_array = array('products_extra_image' => $vv_products_image_extra_7,);
            tep_db_perform('products_extra_images', $sql_status_update_array, 'update', " products_extra_image= '" . $vv_products_image_extra_7 . "'");


}else{
                            if ($vv_products_image_extra_7){
