...
<?php
  $admins_query = tep_db_query("select id, user_name, admin_email_address, admin_firstname, admin_lastname, admin_groups_name from " . TABLE_ADMINISTRATORS . " ad, " . 'admin_groups' . " ag where ad.admin_groups_id = ag.admin_groups_id  order by user_name");
...
?>
                ...
                <td class="dataTableContent"><?php echo $admins['admin_email_address']; ?></td>
                <td class="dataTableContent"><?php echo $admins['admin_firstname']. ' ' . $admins['admin_lastname']; ?></td>
                <td class="dataTableContent"><?php echo $admins['admin_groups_name']; ?></td>
