...
?>
      ...
      <table width="75%" border="2">
        <tr>
          <td width="75%">
           <FORM ENCTYPE="multipart/form-data" ACTION="easypopulate_referencias.php?split=0" METHOD=POST>
              <p>
                <div align = "left">
	  ...
	  <a href="easypopulate_referencias.php?download=stream&dltype=full">Descargar <b>Catalogo completo</b> Editar el archivo con .txt</a><br>

			<!-- VJ product attributes begin //-->
<?php
  if ($products_with_attributes == true) {
?>
	  <a href="easypopulate_referencias.php?download=stream&dltype=attrib">Download <b>Model/Attributes</b> tab-delimited .txt file</a><br>
<?php
  }
?>
...
<p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>
   <p style="margin-top: 0; margin-bottom: 0"><font face="Verdana">PROVEEDOR BINARY</font></p>
<p style="margin-top: 0; margin-bottom: 0"><font face="Verdana">PASO 1</font></p>
<p style="margin-top: 0; margin-bottom: 0"><font face="Verdana"><a href="<?php echo $PHP_SELF . '?codigo=653762&desactivar=ok' ?>">Pulsa aquí para desactivar los productos de
binary</a></font></p>
             <p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>

<p style="margin-top: 0; margin-bottom: 0"><font face="Verdana">PASO 2</font></p>
<p style="margin-top: 0; margin-bottom: 0"><font face="Verdana">Copia y pega este vinculo en el desplegable.</font></p>

               <p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>



          <?php $modelo2 = '<script language="javascript" src="' . 'http://www.euroconsolas.com/euroconsolas/spain/' . 'act_cat.php?modelo=2&proveedors='. 653762 .'&almacen=' . $product_compartir['nombre_publico'] . ' "> </script>';
               echo $modelo2;     ?>
               
                 <?php if ($modo_reducido == 'True'){ ?>
                        <p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>
                  <p style="margin-top: 0; margin-bottom: 0">MODO REDUCIDO</p>
                             <p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>

                <?php
              $modelo3 = '<script language="javascript" src="' . 'http://www.euroconsolas.com/euroconsolas/spain/' . 'act_cat.php?modelo=3&proveedors='. 653762 .'&almacen=' . $product_compartir['nombre_publico'] . ' "> </script>';
               echo $modelo3;
                     }
   ...
   if ($desactivar){
       //      $sql_status_update_array = array('products_status' => '1');   //CAMBIAR 0 PARA DESACTIVAR CON EL PRECIO
   ...
   $prove_values = tep_db_query("select * from " . 'proveedor' . " where proveedor_id= '" . $codigo . "'");
     $prove = tep_db_fetch_array($prove_values);
             ...
             $cabezera .=  STORE_OWNER . ' ' . $prove['proveedor_name'];
  ...
  <p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>
   <p style="margin-top: 0; margin-bottom: 0"><font face="Verdana">PROVEEDOR MAYORISTA CANARIO</font></p>
<p style="margin-top: 0; margin-bottom: 0"><font face="Verdana">PASO 1</font></p>
<p style="margin-top: 0; margin-bottom: 0"><font face="Verdana"><a href="<?php echo $PHP_SELF . '?codigo=653766&desactivar=ok' ?>">Pulsa aquí para desactivar los productos de
Mayorista Canario</a></font></p>
             <p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>
...
<p style="margin-top: 0; margin-bottom: 0"><font face="Verdana">Copia y pega este vinculo en el desplegable.</font></p>
        ...
        <?php $modelo2 = '<script language="javascript" src="' . 'http://www.euroconsolas.com/euroconsolas/spain/' . 'act_cat.php?modelo=12&proveedors='. 653766 .'&almacen=' . $product_compartir['nombre_publico'] . ' "> </script>';
                 echo $modelo2;     ?>
                ...
                <?php
              $modelo3 = '<script language="javascript" src="' . 'http://www.euroconsolas.com/euroconsolas/spain/' . 'act_cat.php?modelo=3&proveedors='. 653766 .'&almacen=' . $product_compartir['nombre_publico'] . ' "> </script>';
               echo $modelo3;
                     }
...
$oldday1 = date("Y-m-d", $time1);
 ...
 // SI NO LO TENEMOS SE MODICA COMO SIEMPRE.
   ...
   $vv_products_cpe = ereg_replace("[0-9]{2}$", "", "$v_products_model");
      ...
      $sql_data_array = array(//  'products_status' => 1,     //CAMBIAR 0 PARA DESACTIVAR CON EL PRECIO
                               'products_last_modified' => $oldday1,);
