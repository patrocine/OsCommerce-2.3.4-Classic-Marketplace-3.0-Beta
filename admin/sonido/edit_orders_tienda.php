  ...
  <?php
      ...
      ?>
  	  <td class="dataTableHeadingContent"><?php echo 'PVP'; ?>
                     <?php echo tep_draw_form('orders', 'edit_orders_tienda.php', '', 'get'); ?>
           <?php
     echo ''  .$ayuda_actualizar.  ' ' . tep_draw_input_field('nuevo_precio_pvp', '', 'size="5"') . tep_draw_hidden_field('action', 'edit') . tep_draw_hidden_field('oID', $oID);
     ...
     ?>
           ...
           <?php
     echo ''  .$ayuda_actualizar.  ' ' . tep_draw_input_field('nuevo_precio_g1', '', 'size="5"') . tep_draw_hidden_field('action', 'edit') . tep_draw_hidden_field('oID', $oID);
     ...
     ?>
           ...
           <?php
     echo ''  .$ayuda_actualizar.  ' ' . tep_draw_input_field('nuevo_precio_g3', '', 'size="5"') . tep_draw_hidden_field('action', 'edit') . tep_draw_hidden_field('oID', $oID);
...
if ($_GET['nuevo_precio_pvp']){

$order->products[$i]['price'] = ($pr_grupos_g2['customers_group_price'] * $_GET['nuevo_precio_pvp'] / 100) + $pr_grupos_g2['customers_group_price'];
  $checked = 'checked';
}
if ($_GET['nuevo_precio_g1']){

$pr_grupos_g1['customers_group_price'] = ($pr_grupos_g2['customers_group_price'] * $_GET['nuevo_precio_g1'] / 100) + $pr_grupos_g2['customers_group_price'];
  $checked = 'checked';
}
if ($_GET['nuevo_precio_g3']){

$pr_grupos_g3['customers_group_price'] = ($pr_grupos_g2['customers_group_price'] * $_GET['nuevo_precio_g3'] / 100) + $pr_grupos_g2['customers_group_price'];
  $checked = 'checked';
}
	echo '	    </td>' . "\n" .
		   //  '	    <td class="' . $RowStyle . '" valign="top">' . "<input name='update_products[$orders_products_id][tax]' size='6' value='" . tep_display_tax_value($order->products[$i]['tax']) . "'>" . '</td>' . "\n" .
