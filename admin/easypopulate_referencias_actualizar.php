...
?>
      ...
      <table width="75%" border="2">
        <tr>
          <td width="75%">
           <FORM ENCTYPE="multipart/form-data" ACTION="easypopulate_referencias_actualizar.php?split=0" METHOD=POST>
              <p>
                <div align = "left">
	  ...
	  <a href="easypopulate_referencias_actualizar.php?download=stream&dltype=full">Descargar <b>Catalogo completo</b> Editar el archivo con .txt</a><br>

			<!-- VJ product attributes begin //-->
<?php
  if ($products_with_attributes == true) {
?>
	  <a href="easypopulate_referencias_actualizar.php?download=stream&dltype=attrib">Download <b>Model/Attributes</b> tab-delimited .txt file</a><br>
<?php
  }
?>
...
$oldday1 = date("Y-m-d", $time1);
    ...
    $ws_products_values = mysql_query("select * from " . TABLE_PRODUCTS . " where products_id = '" . $v_products_id . "'");
     $ws_products = mysql_fetch_array($ws_products_values);
      ...
      $sql_data_array = array('products_model' => $v_products_model);
   ...
   $ws_products_values = mysql_query("select * from " . TABLE_PRODUCTS . " p, " . TABLE_ORDERS_PRODUCTS . " op where  p.products_model = '" . $v_products_model . "'");
  if    ($ws_products_m = mysql_fetch_array($ws_products_values)){
