...
?>
      ...
      <table width="75%" border="2">
        <tr>
          <td width="75%">
           <FORM ENCTYPE="multipart/form-data" ACTION="easypopulate_referencias_sino.php?split=0" METHOD=POST>
              <p>
                <div align = "left">
	  ...
	  <a href="easypopulate_referencias_sino.php?download=stream&dltype=full">Descargar <b>Catalogo completo</b> Editar el archivo con .txt</a><br>

			<!-- VJ product attributes begin //-->
<?php
  if ($products_with_attributes == true) {
?>
	  <a href="easypopulate_referencias_sino.php?download=stream&dltype=attrib">Download <b>Model/Attributes</b> tab-delimited .txt file</a><br>
<?php
  }
?>
...
//---------------------------------------
 ...
 // SI NO LO TENEMOS SE MODICA COMO SIEMPRE.
  ...
  // 1 modifica el producto 0 no  modifica el status
   ...
   if  ($modificar_producto = mysql_fetch_array($modificar_producto_values)){
      ...
      $sql_data_array = array('products_status' => $v_db_status,
