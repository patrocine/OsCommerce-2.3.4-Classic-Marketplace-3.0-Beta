...
// si el precio es un numero ejecuto el siguiente codigo
 ...
 //  la primera vez que se inserta un precio con mismo products_id
     ...
     $orders_values = mysql_query("select * from " . TABLE_ORDERS . " o, " . TABLE_PRODUCTS . " p, " . 'administrators' . " a, " . TABLE_ORDERS_PRODUCTS . " op where o.orders_id = op.orders_id and op.products_id = '" . $v_products_id . "' and p.products_id = '" . $v_products_id . "' and o.orders_status = a.abono and op.products_quantity >= 1 ");
  ...
  if ( $vv_codigodebarras == 0){
     ...
     $wersdfs = mysql_fetch_array($wersdfs_values);
      ...
      $sql_data_array = array('products_image' => $v_products_image,
         ...
         if ($v_products_price <> 0) $sql_data_array['products_price'] = $v_products_price;
         if ($vv_customers_group_price_2 <> 0) $sql_data_array['proveedor_price_general'] = $vv_customers_group_price_2;
         if ($v_manufacturers_name) $sql_status_update_array['manufacturers_name'] = $v_manufacturers_name;
   ...
   //   if ($vv_modificar_producto == 1){
     ...
     $wersdfs = mysql_fetch_array($wersdfs_values);
             ...
             $regladeprecios_values = mysql_query("select * from " . 'products_regladeprecios' . " where regladeprecios= '" . $wersdfs['products_regladeprecios'] . "' ORDER BY menor DESC");
    while ($regladeprecios= mysql_fetch_array($regladeprecios_values)){
...
// si el precio es un numero ejecuto el siguiente codigo
 ...
 if ($v_products_price){
  ...
  // fin de alertas de mail.
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 1 and products_id = '" . $v_products_id . "' and products_extra_image <> '" . $vv_products_image_extra_1 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){
    ...
    $pr_imagenes_insert_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 1 and products_id = '" . $v_products_id . "' and products_extra_image = '" . $vv_products_image_extra_1 . "'");
if ($pr_imagenes_insert = mysql_fetch_array($pr_imagenes_insert_values)){
  ...
  // Actualiza o inserta las imagenes extras. del grupo 2
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 2 and products_id = '" . $v_products_id . "' and products_extra_image <> '" . $vv_products_image_extra_2 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){
    ...
    $pr_imagenes_insert_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 2 and products_id = '" . $v_products_id . "' and products_extra_image = '" . $vv_products_image_extra_2 . "'");
if ($pr_imagenes_insert = mysql_fetch_array($pr_imagenes_insert_values)){
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 3 and products_id = '" . $v_products_id . "' and products_extra_image <> '" . $vv_products_image_extra_3 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){
    ...
    $pr_imagenes_insert_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 3 and products_id = '" . $v_products_id . "' and products_extra_image = '" . $vv_products_image_extra_3 . "'");
if ($pr_imagenes_insert = mysql_fetch_array($pr_imagenes_insert_values)){
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 4 and products_id = '" . $v_products_id . "' and products_extra_image <> '" . $vv_products_image_extra_4 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){
    ...
    $pr_imagenes_insert_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 4 and products_id = '" . $v_products_id . "' and products_extra_image = '" . $vv_products_image_extra_4 . "'");
if ($pr_imagenes_insert = mysql_fetch_array($pr_imagenes_insert_values)){
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 5 and products_id = '" . $v_products_id . "' and products_extra_image <> '" . $vv_products_image_extra_5 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){
    ...
    $pr_imagenes_insert_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 5 and products_id = '" . $v_products_id . "' and products_extra_image = '" . $vv_products_image_extra_5 . "'");
if ($pr_imagenes_insert = mysql_fetch_array($pr_imagenes_insert_values)){
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 6 and products_id = '" . $v_products_id . "' and products_extra_image <> '" . $vv_products_image_extra_6 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){
    ...
    $pr_imagenes_insert_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 6 and products_id = '" . $v_products_id . "' and products_extra_image = '" . $vv_products_image_extra_6 . "'");
if ($pr_imagenes_insert = mysql_fetch_array($pr_imagenes_insert_values)){
   ...
   $pr_imagenes_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 7 and products_id = '" . $v_products_id . "' and products_extra_image <> '" . $vv_products_image_extra_7 . "'");
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){
    ...
    $pr_imagenes_insert_values = mysql_query("select * from " . 'products_extra_images' . " where image_number = 7 and products_id = '" . $v_products_id . "' and products_extra_image = '" . $vv_products_image_extra_7 . "'");
if ($pr_imagenes_insert = mysql_fetch_array($pr_imagenes_insert_values)){
