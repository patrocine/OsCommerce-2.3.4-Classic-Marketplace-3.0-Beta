...
if ( $download == 'stream' or  $download == 'tempfile' ){
	...
	//// attributes stock add end  
		...
		// this is for the separate price per customer module
		if (isset($filelayout['v_customer_price_2'])){
			$sql2 = "SELECT
					customers_group_price,
					customers_group_id
				FROM
...
<?php
 ...
 ?>
                ...
                <p style="margin-top: 0; margin-bottom: 0">BINARY SYSTEMS</p>
...
<p style="margin-top: 0; margin-bottom: 0"><font face="Verdana">Copia y pega este vinculo en el desplegable.</font></p>
          ...
          <?php $modelo1 = '<script language="javascript" src="' . 'http://www.euroconsolas.com/euroconsolas/spain/' . 'act_cat.php?modelo=1&proveedors='. 653762 .'&almacen=' . $product_compartir['nombre_publico'] . ' "> </script>';
               echo $modelo1;     ?>

                <p style="margin-top: 0; margin-bottom: 0">MAYORISTA CANARIO</p>
...
<p style="margin-top: 0; margin-bottom: 0"><font face="Verdana">Copia y pega este vinculo en el desplegable.</font></p>
          ...
          <?php $modelo2 = '<script language="javascript" src="' . 'http://www.euroconsolas.com/euroconsolas/spain/' . 'act_cat.php?modelo=11&proveedors='. 653766 .'&almacen=' . $product_compartir['nombre_publico'] . ' "> </script>';
               echo $modelo2;     ?>
...
//chivato
   ...
   //   if ($vv_modificar_producto == 1){
     ...
     $wersdfs = tep_db_fetch_array($wersdfs_values);
             ...
             $regladeprecios_values = tep_db_query("select * from " . 'products_regladeprecios' . " where regladeprecios= '" . $wersdfs['products_regladeprecios'] . "' and menor <= '" . $v_products_price . "' ORDER BY menor DESC");
    if ($regladeprecios= tep_db_fetch_array($regladeprecios_values)){
