...
?>
      ...
      <table width="75%" border="2">
        <tr>
          <td width="75%">
           <FORM ENCTYPE="multipart/form-data" ACTION="easypopulate_extraimage_description.php?split=0" METHOD=POST>
              <p>
                <div align = "left">
	  ...
	  <a href="easypopulate_extraimage_description.php?download=stream&dltype=full">Descargar <b>Catalogo completo</b> Editar el archivo con .txt</a><br>

			<!-- VJ product attributes begin //-->
<?php
  if ($products_with_attributes == true) {
?>
	  <a href="easypopulate_extraimage_description.php?download=stream&dltype=attrib">Download <b>Model/Attributes</b> tab-delimited .txt file</a><br>
<?php
  }
?>
...
if ($pr_imagenes = mysql_fetch_array($pr_imagenes_values)){
		...
		// the following is common in both the updating an existing product and creating a new product
            ...
            tep_db_perform(TABLE_PRODUCTS_DESCRIPTION, $sql_status_update_array, 'update', " products_id= '" . $v_products_id . "' and language_id = '".$key."' ");
                         ...
                         $sql_status_update_array = array('products_quantity' => $v_products_quantity,);

                            if ($v_manufacturers_name) $sql_status_update_array['manufacturers_name'] = $v_manufacturers_name;
                            if ($vv_referencia_fabricante) $sql_status_update_array['referencia_fabricante'] = $vv_referencia_fabricante;
