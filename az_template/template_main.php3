...
*/
 // Función para obtener el precio de una criptomoneda específica desde CoinGecko
function obtenerPrecio($id) {
    // URL de la API de CoinGecko para obtener el precio de una moneda específica
    ...
    // Ejecutar y obtener la respuesta de la API
    ...
    // Verificar si hay datos y devolver el precio en USD
...
// Obtener el precio de $SAUCE y $HBAR
$precioSauce = obtenerPrecio("saucerswap");
$precioHbar = obtenerPrecio("hedera-hashgraph");
$preciobtc = obtenerPrecio("bitcoin");

// Mostrar los resultados
echo "Precio de SAUCE: $".$precioSauce." USD\n";
echo "Precio de HBAR: $".$precioHbar." USD\n";
echo "Precio de BTC: $".$preciobtc." USD\n";
...
echo '<b>Descuento del ' . DESCUENTO_CLIENTE . '% en '.$sumar_ofertas['value'].' Productos</b>';
      ...
      ?>
<a href=" <?php  echo   'index.php' . '?cPath=' . $cPath . '&favoritos=' . 'edit'?>"><img border="0" src="images/favoritos.png" width="" height="32"> </a>
 <a href=" <?php  echo   'https://www.saucerswap.finance/swap/0.0.456858/0.0.4817159' ?>"><img border="0" src="images/islascanarias.png" width="" height="32"> </a>


 <a href=" <?php  echo   'https://www.saucerswap.finance/swap/0.0.456858/0.0.5280509' ?>"><img border="0" src="images/lapalma.png" width="" height="32"> </a>
<a href=" <?php  echo   'https://www.saucerswap.finance/swap/0.0.456858/0.0.5287153' ?>"><img border="0" src="images/elhierro.png" width="" height="32"> </a>
<a href=" <?php  echo   'https://www.saucerswap.finance/swap/0.0.456858/0.0.5276180' ?>"><img border="0" src="images/lagomera.png" width="" height="32"> </a>
<a href=" <?php  echo   'https://www.saucerswap.finance/swap/0.0.456858/0.0.5255339' ?>"><img border="0" src="images/tenerife.png" width="" height="32"> </a>
<a href=" <?php  echo   'https://www.saucerswap.finance/swap/0.0.456858/0.0.5259118' ?>"><img border="0" src="images/grancanaria.png" width="" height="32"> </a>
<a href=" <?php  echo   'https://www.saucerswap.finance/swap/0.0.456858/0.0.5267344' ?>"><img border="0" src="images/lanzarote.png" width="" height="32"> </a>
<a href=" <?php  echo   'https://www.saucerswap.finance/swap/0.0.456858/0.0.5269837' ?>"><img border="0" src="images/fuerteventura.png" width="" height="32"> </a>
...
<a href=" <?php  echo   'https://www.saucerswap.finance/swap/0.0.456858/0.0.5267344' ?>"><img border="0" src="images/lanzarote.png" width="" height="32"> </a>
<a href=" <?php  echo   'https://www.saucerswap.finance/swap/0.0.456858/0.0.5269837' ?>"><img border="0" src="images/fuerteventura.png" width="" height="32"> </a>
<p><b>Todos los productos de este canal de ventas estan sincronizados con los stock reales del comercio.</b></p>
<p>
<img border="0" src="images/deli3.png" width="500" height="">
<img border="0" src="images/deli2.png" width="459" height="">
