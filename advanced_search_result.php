...
// create column list
  ...
  $select_str = "select distinct " . $select_column_list . " m.manufacturers_id, p.codigo_proveedor, p.products_porcentage, p.referencia_fabricante, p.products_id, time_entradasysalidas, p.stock_nivel, p.products_status, pd.products_name, p.products_price, p.products_tax_class_id, IF(s.status, s.specials_new_products_price, NULL) as specials_new_products_price, IF(s.status, s.specials_new_products_price, p.products_price) as final_price ";
  ...
  /************** BEGIN SITESEARCH CHANGE ****************/
  require(DIR_WS_MODULES . FILENAME_SITE_SEARCH);
  /************** END SITESEARCH CHANGE ******************/
?>
