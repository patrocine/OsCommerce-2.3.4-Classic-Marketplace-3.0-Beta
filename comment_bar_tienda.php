...
<?php  $orderss_values = tep_db_query("select * from " . TABLE_ORDERS . " where orders_id = '" . $oID . "'");
  ...
  $direccion_empresa = tep_db_fetch_array($direccion_empresa_values);
    ...
    //Configuración
$datos_empresa = 'EUROCONSOLAS S.L. \n Estación de Guaguas de la Orotava, 3º Planta \n La Orotava 38300 \n Santa Cruz de Tenerife';
...
<button class="cbutton" onClick=" updateComment('Le informamos que hoy día <?php echo date("d-m-Y"); ?> su pedido ya esta disponible en <?php echo $direccion_empresa['admin_firstname'] . '  ' . $direccion_empresa['admin_lastname']; ?> que esta situado en <?php echo $direccion_empresa['admin_direccion'] . ' en ' . $direccion_empresa['admin_poblacion']; ?> \n Cuando quiera ya puede venir a recogerlo. \n Para cualquier consulta puede llamarnos al <?php echo $direccion_empresa['admin_telefono'] . ' - ' . $direccion_empresa['admin_movil']; ?>  \n  \n ','17');">Recoger</button>&nbsp;
